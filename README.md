...
| ------ | --------------: | --------------------------------------------------------------------------- |
| page   |        31 ≈ 54% | 缺页码或页码错误                                                            |
| lang   |        14 ≈ 25% | `等`/`et al.`等语言翻译问题                                                 |
| 卷     |         9 ≈ 16% | 多`卷`字，比如`第4册`误为`卷 第4册`                                         |
| case   |         7 ≈ 12% | 大小写问题，例如英文机构名称被全大写                                        |
| space  |        16 ≈ 28% | 空格差异，例如“第 1 卷”与“第1卷”；也有些是错误，比如`GB/T 123`误为`GB/T123` |
...
|      4 ≈ 7% | 卷 + space              |
|      3 ≈ 5% | 卷 + page + space       |
|      2 ≈ 4% | page + escape + space   |
|      1 ≈ 2% | case + escape + space   |
|      1 ≈ 2% | page + lang             |
|    12 ≈ 21% | 其它                    |
|   57 = 100% | 合计                    |
